...
import bladeDiffuse from "../images/blade-diffuse.jpg"
import bladeAlpha from "../images/blade-alpha.jpg"
...
export default function Grass({ options = { bW: 0.12, bH: 1, joints: 5 }, width = 100, instances = 50000, ...props }) {
  ...
  const groundGeo = useMemo(() => {
    const geo = new Geometry().fromBufferGeometry(new THREE.PlaneGeometry(width, width, 500, 500))
  ...
  return (
    <group {...props}>
      ...
      <mesh position={[0, 0, 0]} geometry={groundGeo}>
        <meshStandardMaterial color="#12361c" />
      </mesh>
    </group>
  )
}
